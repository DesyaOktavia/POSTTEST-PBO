...
import jamusehat.model.JamuBubuk;
import jamusehat.model.JamuCair;
...
public class Main {
    ...
    protected void jalankan() {
        daftarJamu.add(new JamuCair("J1", "Kunyit Asam", "Daya tahan tubuh", 15000, 50));
        daftarJamu.add(new JamuCair("J2", "Beras Kencur", "Pegal linu", 12000, 40));
        daftarJamu.add(new JamuBubuk("J3", "Temulawak", "Kesehatan hati", 18000, 30));
        daftarJamu.add(new JamuBubuk("J4", "Pahitan", "Detokfikasi Tubuh", 20000, 35));
        daftarJamu.add(new JamuCair("J5", "Temulawak", "Kesehatan hati", 18000, 30));
        ...
        daftarAdmin.add(new Admin("A001", "Eca", "eca", "eca123"));
